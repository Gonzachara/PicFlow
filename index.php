...
if(isset($_SESSION['Auth']) && $user['ac_status']==1 && !$pagecount){
    ...
    showPage('header',['page_title'=>'Verificar tu correo electrónico']);
    ...
    showPage('header',['page_title'=>'Pictogram - Registro']);
    showPage('signup');
    ...
    showPage('header',['page_title'=>'Pictogram - Olvidé mi contraseña']);
    ...
    if(isset($_SESSION['Auth']) && $user['ac_status']==1){
        ...
        showPage('header',['page_title'=>'Pictogram - Iniciar sesión']);
        showPage('login');
    }
